<article class="into" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <p>My primary reason for wanting to create this site is to bring my work to a wider audience and present my
       portfolio. Please feel free to <a href="Contact.php">contact</a> me if anything you see interests and intrigues you, or you wish to discuss any opportunities.
    </p>

    <P>I hope you have a great time looking around, please see details in my gallery if your interest in purchasing
       any of my work


        <div class="sig">Shan <img class="profPic" src="/_/img/Thumbnails/shanProf.jpg"></div>
